...
<html lang="eu">
  ...
  <body class="web-gorputza">
    <header class="goiburu-nagusia">
      <nav class="nab-edukiontzia">
        <div class="goiburu-barnealdea">
          ...
          <div class="nab-ekintzak" style="position: relative">
            <!-- saioa hasi botoia -->
            <a href="../html/bezeroa_saioa_hasi.html" class="saioa-hasi-botoia" id="saioa-hasi-botoia">Saioa Hasi</a>
            <!-- saskia botoia -->
            <button class="saski-botoia" id="saski-botoia-toggle">
              <!-- karrito ikonoa -->
              <i class="fas fa-shopping-cart"></i>
              <span>Saskia</span>
              <!-- Hemen saski kontagailua hasten da (0 balioarekin adibidez) -->
    ...
    <footer class="oin-nagusia">
      <div class="oin-sarea">
        <!-- OINA ezkerreko zutabea (BIRTEK eta testua) -->
        <div class="testua-erdian md:text-left">
          <h3 class="oin-izenburua">BIRTEK</h3>
          <p class="oin-testua">
            Teknologia berreskuratzen, etorkizuna eraikitzen. Goierri Eskolan
            kokatuta.
          </p>
        </div>
        <!-- OINA erdiko zutabea (Jarrai gaitzazu,sare sozialak eta botoia whatsapp) -->
        <div class="testua-erdian">
          <h4 class="oin-goiburua">Jarrai Gaitzazu</h4>
          <div class="oin-sozial-lerroa">
            <!-- sare-sozial IKONO estekak -->
          ...
          <div>
            <!-- whatsapp esteka -->
            <a href="https://wa.me/34600000000" class="oin-whatsapp-botoia"><i class="fab fa-whatsapp"></i> WhatsApp</a>
          </div>
        </div>
        <div class="testua-erdian md:text-right">
          ...
          <ul class="oin-nab-zerrenda">
            <li><a href="../html/hasiera.html" class="oin-lotura">Hasiera</a></li>
            <li><a href="produktuak.php" class="oin-lotura">Produktuak</a></li>
            <li><a href="../html/berriak.html" class="oin-lotura">Berriak</a></li>
            <li><a href="../html/kontaktua.html" class="oin-lotura">Kontaktua</a></li>
            <li><a href="../html/hornitzailea_saioa_hasi.html" class="oin-lotura">Birziklatu</a></li>
            <li><a href="../html/langileak_menua.html" class="oin-lotura">Langileak</a></li>
          </ul>
        </div>
      </div>
