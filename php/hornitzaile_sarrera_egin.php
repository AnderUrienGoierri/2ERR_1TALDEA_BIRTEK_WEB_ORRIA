...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($mota_sarrera == 'existing') {
            ...
            switch($mota) {
                case 'Eramangarria':
                case 'Mahai-gainekoa': $kategoria_id = 1; break;
                case 'Mugikorra':
                case 'Tableta': $kategoria_id = 2; break;
                case 'Pantaila': $kategoria_id = 3; break;
                case 'Periferikoa': 
                case 'Kablea': $kategoria_id = 4; break;
                case 'Softwarea': $kategoria_id = 5; break;
                case 'Zerbitzaria': $kategoria_id = 6; break;
            }
            ...
            $db_mota = $mota;
            if ($mota == 'Periferikoa') $db_mota = 'Periferikoak';
            if ($mota == 'Kablea') $db_mota = 'Kableak';
    ...
    <main class="eduki-nagusia">
        <div class="kontaktu-edukiontzia">
            ...
            <div class="inprimaki-kutxa sarrera-edukiontzia">
                <?php if ($mezua): ?>
                    <p class="mezu-kutxa <?= strpos($mezua, 'Errorea') !== false ? 'mezu-errorea' : 'mezu-arrakasta' ?>"><?= $mezua ?></p>
                <?php endif; ?>
                ...
                <form class="kontaktu-inprimaki-diseinua" method="POST" id="main-form">
                    ...
                    <div id="section-new" class="ezkutuan">
                        <div class="sarrera-sareta-berria">
                            ...
                            <select name="mota" id="produktu_mota_select" class="inprimaki-sarrera" required onchange="toggleFormFields()">
