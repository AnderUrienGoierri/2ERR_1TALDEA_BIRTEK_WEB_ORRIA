...
- **Responsive Design**: Mugikorretarako egokitzapenak egitea ("Mobile First" ikuspegia). Taula konplexuetan, `display: block` eta `::before` sasi-klaseak erabiltzen dira taula-lerroak txartel bihurtzeko eta etiketak dinamikoki gehitzeko.
